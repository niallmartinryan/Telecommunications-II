...
//			int[] smartPhones = {}
		...
		//intialise Laptops
		new Laptop(terminal, PORT_A,routersA ,smartPhonesA );
		new Laptop(terminal, PORT_B,routersB ,smartPhonesB );
		new Laptop(terminal, PORT_C,routersC ,smartPhonesC );
		new Laptop(terminal, PORT_D,routersD ,smartPhonesD );
		new Laptop(terminal, PORT_E,routersE ,smartPhonesE );
		new Laptop(terminal, PORT_F,routersF ,smartPhonesF );
