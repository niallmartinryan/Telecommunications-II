...
public class RoutingTable{
	...
	RoutingTable(Integer[] dests, int routerID){
	...
	RoutingTable(ArrayList<Integer> dest, ArrayList<Integer> cost, ArrayList<Integer> nextNode, int routerID){
	...
	public String printTable(){
		String result =("destinations	-	cost	-	nextNode\n");
		for(int i =0; i < dest.size(); i++){
			result =result + (dest.get(i)+ "		"+ cost.get(i) + "		" + nextNode.get(i)+"\n");
		}
